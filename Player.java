...
public class Player {
	...
	*/
	...
	public void draw(){
		...
		GameLib.fillRect(this.cx, this.cy, width, height);
	}
	...
	*/
	...
	public void moveUp(long delta){
		double nextPosition = delta / speed;
		double realPosition = this.cy - (this.height / 2);
		
		if(realPosition - nextPosition > v_limit[0]){
			this.cy -= nextPosition; 
		}
	}
	/**
	...
	*/
	...
	public void moveDown(long delta){
		double nextPosition = delta / speed;
		double realHeight = this.cy + (this.height / 2);
		if(realHeight + nextPosition < v_limit[1]){
			this.cy += nextPosition; 
		}
	}
